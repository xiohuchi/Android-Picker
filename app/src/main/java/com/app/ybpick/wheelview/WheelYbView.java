...
package com.app.ybpick.wheelview;
...
public class WheelYbView extends View {
    ...
    // Listeners
    private List<OnYbWheelChangedListener> changingListeners = new LinkedList<OnYbWheelChangedListener>();
     ...
     */
    public void addChangingListener(OnYbWheelChangedListener listener) {
     ...
     * @param listener the listener
     */
    public void removeChangingListener(OnYbWheelChangedListener listener) {
    ...
    protected void notifyChangingListeners(int oldValue, int newValue) {
        for (OnYbWheelChangedListener listener : changingListeners) {
